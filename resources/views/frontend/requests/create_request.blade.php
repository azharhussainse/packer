        ...
        <div class="row">
            {{ Form::open(['route' => 'frontend.requests.store', 'class' => 'form-horizontal m-auto', 'role' => 'form', 'method' => 'post', 'files' => true]) }}
                    <div class="col">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                {{ Form::label('required_by_date', 'Required By Date', ['class' => 'from-control-label required']) }}

                                {{ Form::date('required_by_date', null, ['class' => 'form-control', 'required' => 'required', 'min'=>date("Y-m-d")]) }}
                            </div>
                            <!--col-->
                        </div>
                        <!--form-group-->
