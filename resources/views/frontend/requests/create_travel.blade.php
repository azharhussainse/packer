                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                {{ Form::date('go_date', null, ['class' => 'form-control', 'required' => 'required', 'min'=>date("Y-m-d")]) }}
                            </div>
                            <div class="col-md-6">
                                {{ Form::label('return_date', 'Return Date', ['class' => 'from-control-label required']) }}

                                {{ Form::date('return_date', null, ['class' => 'form-control', 'required' => 'required', 'min'=>date("Y-m-d")]) }}
                            </div>
                            <!--col-->
                        </div>
                        <!--form-group-->
