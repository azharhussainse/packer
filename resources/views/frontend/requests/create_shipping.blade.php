                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                {{ Form::select('source_city', [], null,['class' => 'form-control', 'placeholder' => 'Travel From City']) }}
                            </div>
                            <!--col-->
                        </div>
                        <!--form-group-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                {{ Form::select('destination_city', [], null,['class' => 'form-control', 'placeholder' => 'Travel To City']) }}
                            </div>
                            <!--col-->
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                {{ Form::label('shipping_rate', 'Shipping Rate', ['class' => 'from-control-label required']) }}
                                {{ Form::text('shipping_rate', null, ['class' => 'form-control', 'placeholder' => 'Shipping Rate', 'required' => 'required']) }}
                            </div>
                            <!--col-->
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
                                {{ Form::label('upcoming_shipping_date', 'Upcoming Shipment Date', ['class' => 'from-control-label required']) }}

                                {{ Form::date('upcoming_shipping_date', null, ['class' => 'form-control', 'required' => 'required', 'min'=>date("Y-m-d")]) }}
                            </div>
                            <!--col-->
                        </div>
                        <!--form-group-->
                        <div class="form-group row">
                            <div class="col-md-12">
                                {{ Form::label('weight_available', 'Shipping Weight Available', ['class' => 'from-control-label required']) }}
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input name="allow_location" type="checkbox" value="yes" id="allow_location">
...
@push('after-scripts')
    <script>
        ...
        jQuery(document).ready(function($){
            ...
            $("#allow_location").on('change',function(){
                if($(this).is(":checked")){
                    getLocation();
                }else{
                    lat.value = "";
