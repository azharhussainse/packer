                    ...
                    <div class="col">
                        ...
                        <div id="product_details">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" placeholder="Product Link" name="product_link[]" type="text" value="" id="product_link[]">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                {{ Form::date('required_by_date', null, ['class' => 'form-control', 'required' => 'required', 'min'=>$post->required_by_date]) }}
                            </div>
                            <!--col-->
                        </div>
                        <!--form-group-->
